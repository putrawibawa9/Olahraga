...
<head>
    ...
    <style>
        ...
        .catalog-link {
            ...
            background-color: #ffc107; /* Background color for a classy look */
        ...
        .catalog-link a {
            ...
            color: #333; /* Example: red text color */
            text-decoration: none;
...
<body>
    ...
    <section>
        ...
        <div class="image-grid">
            ...
            <a href="team/userView.php">Klik Lebih Lanjut</a>
        </div>
        </div>
    </section>
